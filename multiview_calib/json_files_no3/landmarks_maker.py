...
f = open('../json_files/results/result_6_1.json')
data = json.load(f)
ids = [*range(0,17)]
ids.remove(3)
ids.remove(4)
...
f = open('../json_files/results/result_6_2.json')
data = json.load(f)
...
f = open('../json_files/results/result_6_4.json')
data = json.load(f)
...
f = open('../json_files/results/result_6_5.json')
data = json.load(f)
...
for i in range(len(dict_list)):
    ...
    save_path = "/cvlabdata2/home/susam/Motion-Correction/multiview_calib/json_files_no3/landmarks"
